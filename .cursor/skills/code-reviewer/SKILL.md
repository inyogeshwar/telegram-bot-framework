...
- `scripts/review.py` — Automated code review
- `scripts/lint.py` — Linting and formatting check

## References

- `references/STYLE_GUIDE.md` — Code style guidelines
- `references/BEST_PRACTICES.md` — Best practices reference
